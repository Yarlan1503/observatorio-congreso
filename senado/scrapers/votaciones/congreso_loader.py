...
# votaciones/congreso_loader.py → parent=votaciones → parent=scrapers → parent=senado → parent=proyecto
_db_module_path = str(Path(__file__).resolve().parent.parent.parent.parent / "db")
