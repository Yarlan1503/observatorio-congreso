...
Uso:
    python -m senado.scrapers.perfiles --from-listing
    python -m senado.scrapers.perfiles --from-listing --limit 10 --dry-run
    python -m senado.scrapers.perfiles --range 1 1754 --delay 2.0
    python -m senado.scrapers.perfiles --test-id 1
    python -m senado.scrapers.perfiles --test-id 1575 --dry-run
    python -m senado.scrapers.perfiles --stats
"""
...
from senado.scrapers.shared.config import (
    BASE_URL_LXVI,
    COOKIE_PATH,
    DB_PATH,
    SENADO_ORG_ID,
        ...
        if legislaturas:
            ...
            for leg in legislaturas:
                ...
                if existing:
                    ...
                    if not dry_run:
                        from db.id_generator import next_id
...
Ejemplos:
  python -m senado.scrapers.perfiles --from-listing
  python -m senado.scrapers.perfiles --from-listing --limit 10 --dry-run
  python -m senado.scrapers.perfiles --range 1 1754
  python -m senado.scrapers.perfiles --range 1 1754 --delay 3.0
  python -m senado.scrapers.perfiles --range 1 100 --limit 10
  python -m senado.scrapers.perfiles --test-id 1
  python -m senado.scrapers.perfiles --test-id 1575 --dry-run
  python -m senado.scrapers.perfiles --stats
        """,
