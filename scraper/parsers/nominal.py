...
from scraper.models import NominalVotacion, VotoNominal
...
def parse_nominal(html: str, sitl_id: int, partido_nombre: str) -> NominalVotacion:
    ...
    Args:
        ...
        partido_nombre: Nombre del partido (puede sobreescribirse con el del HTML).
    ...
    # Detectar partido del HTML si está disponible
    partido_detectado = _extraer_partido(soup)
    if partido_detectado:
        partido_nombre = partido_detectado
